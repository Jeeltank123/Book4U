...
if(isset($message)){
    ...
    <div class="container">
        <form action="" method="post">
            <h3 style="color:white">login to <a href="index.php"><span>book</span><span>4U</span></a></h3>
            ...
            <p>Don't have an Account? <br><br> <a class="link" href="Register.php">Sign Up</a><a class="link" href="index.php">Back</a></p>
        </form>
    </div>
