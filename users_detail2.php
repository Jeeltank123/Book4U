...
<body>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="users_detail2.php?delete_user=<?php echo $fetch_user['Id']; ?>" onclick="return confirm('Are you sure you want to delete this user');">Delete</a>
            </div>
    ...
    <script>
        document.querySelector('#close-update_user').onclick = () => {
            ...
            window.location.href = 'users_detail2.php';
        }
    </script>
