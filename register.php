...
<html lang="en">
  ...
  background-image: linear-gradient(45deg,
    rgba(0, 0, 3, 0.1),
    rgba(0, 0, 0, 0.5)), url(C:\xampp\htdocs\bookflix\bgimg\1.jpg);
  ...
  <?php
    ...
    <div class="container">
      <form action="" method="post">
         <h3 style="color:white">Register to Use <a href="index.php"><span>Book</span><span>4U</span></a></h3>
         ...
         <p>Already have a Account? <br><br> <a class="link" href="login.php">Login</a><a class="link" href="index.php">Back</a></p>
      </form>
    </div>
